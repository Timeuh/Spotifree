...
<body class="flex flex-col items-center h-screen bg-gradient-to-r from-maximumRed via-maximumYellowRed to-lemonMeringue">
    <header class="flex flex-row flex-wrap items-center justify-center w-screen h-1/6 bg-prussianBlue border-lemonMeringue border-b-2 rounded-b-md">
    ...
    <main class="flex flex-col h-full w-3/6 justify-center">
        <div class="flex flex-col text-lemonMeringue text-center bg-prussianBlue space-y-8 h-4/6 justify-center items-center border-lemonMeringue border-double border-4 rounded-md font-bold">
            ...
            <a href="src/pages/login.php" class="border-2 border-orange rounded-md w-3/6 hover:text-lemonMeringue hover:bg-maximumRed bg-lemonMeringue text-maximumRed text-2xl">Se connecter</a>
        </div>
    </main>
